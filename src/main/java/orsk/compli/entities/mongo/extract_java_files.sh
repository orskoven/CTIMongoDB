...
PACKAGE_DIR="/Users/simonbeckmann/IdeaProjects/compliMongoDB/src/main/java/orsk/example/entities"

# Define the output file
OUTPUT_FILE="/Users/simonbeckmann/IdeaProjects/compliMongoDB/src/main/java/orsk/example/entities/extracted_code.txt"
